...
-- Schema siapd
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `siapd` DEFAULT CHARACTER SET latin1 ;
USE `siapd` ;
...
-- -----------------------------------------------------
-- Table `siapd`.`t_casillero_estudiante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`t_casillero_estudiante` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `estudiante` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_casillero_estudiante_casillero`
    ...
    REFERENCES `siapd`.`t_casillero` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `siapd`.`t_conductas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`t_conductas` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `estudiante` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `siapd`.`t_documento_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`t_documento_usuario` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `siapd`.`t_usuario_temp` (
  ...
  `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tipo_usuario` VARCHAR(45) NOT NULL DEFAULT '1',
...
-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_admin_estudiante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_admin_estudiante` (`id` INT, `cedula` INT, `foto` INT, `apellido` INT, `nombre` INT, `nacimiento` INT, `usuario` INT, `sexo` INT, `correo` INT, `id_estudiante` INT, `celular` INT, `telefono` INT, `nivel` INT, `descripcion` INT, `carrera_departamento` INT, `cantidad_dias` INT, `telefono_emergencia` INT, `provincia` INT, `canton` INT, `distrito` INT, `direccion` INT, `moroso` INT, `estado` INT, `notas` INT, `prematricula` INT, `motivo_ingreso` INT, `tipo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_administradores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_administradores` (`id` INT, `cedula` INT, `foto` INT, `nombre` INT, `apellido` INT, `nacimiento` INT, `usuario` INT, `sexo` INT, `correo` INT, `clave` INT, `id_administrativo` INT, `rol` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_anotaciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_anotaciones` (`id_anotaciones` INT, `nota` INT, `id_profesor` INT, `created_at` INT, `updated_at` INT, `cedula_profesor` INT, `apellido_profesor` INT, `nombre_profesor` INT, `id_estudiante` INT, `cedula_estudiante` INT, `apellido_estudiante` INT, `nombre_estudiante` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_asistencia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_asistencia` (`id_asistencia` INT, `fecha` INT, `id_matricula` INT, `id_grupo` INT, `id_taller` INT, `codigo` INT, `id_estudiante` INT, `foto` INT, `id_usuario` INT, `cedula` INT, `apellido` INT, `nombre` INT, `estado` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_asistencia_admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_asistencia_admin` (`id_asistencia` INT, `fecha` INT, `id_matricula` INT, `id_grupo` INT, `id_taller` INT, `codigo` INT, `id_estudiante` INT, `foto` INT, `id_usuario` INT, `cedula` INT, `apellido` INT, `nombre` INT, `estado` INT, `profesor` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_cantidad_usuarios_registrados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_cantidad_usuarios_registrados` (`cantidad` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_casilleros`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_casilleros` (`id_casillero` INT, `codigo_casillero` INT, `id_reserva` INT, `id_estudiante` INT, `id_usuario` INT, `cedula` INT, `hora_entrada` INT, `hora_salida` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_cliente_estudiante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_cliente_estudiante` (`id` INT, `cedula` INT, `foto` INT, `apellido` INT, `nombre` INT, `correo` INT, `nacimiento` INT, `usuario` INT, `sexo` INT, `id_estudiante` INT, `celular` INT, `telefono` INT, `nivel` INT, `carrera_departamento` INT, `cantidad_dias` INT, `telefono_emergencia` INT, `provincia` INT, `canton` INT, `distrito` INT, `direccion` INT, `tipo` INT, `moroso` INT, `motivo_ingreso` INT, `estado` INT, `clave` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_conductas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_conductas` (`id_conducta` INT, `texto` INT, `strike` INT, `tipo` INT, `created_at` INT, `id_estudiante` INT, `estado` INT, `foto` INT, `cedula` INT, `apellido` INT, `nombre` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_documentos_usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_documentos_usuarios` (`id_documento` INT, `tipo_documento` INT, `documento` INT, `created_at` INT, `updated_at` INT, `id_estudiante` INT, `id_usuario` INT, `cedula` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_estadistica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_estadistica` (`cantidad_talleres` INT, `cantidad_grupos` INT, `cantidad_matriculados` INT, `cantidad_estudiantes` INT, `cantidad_administrativos` INT, `cantidad_profesores` INT, `cantidad_usuarios` INT, `cantidad_usuarios_temp` INT, `cantidad_horarios` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_estudiante_moroso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_estudiante_moroso` (`id` INT, `cedula` INT, `foto` INT, `apellido` INT, `nombre` INT, `correo` INT, `nacimiento` INT, `usuario` INT, `sexo` INT, `id_estudiante` INT, `celular` INT, `telefono` INT, `nivel` INT, `carrera_departamento` INT, `cantidad_dias` INT, `telefono_emergencia` INT, `provincia` INT, `pago` INT, `canton` INT, `distrito` INT, `direccion` INT, `tipo` INT, `moroso` INT, `motivo_ingreso` INT, `estado` INT, `clave` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_grupos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_grupos` (`codigo_taller` INT, `costo` INT, `costo_funcionario` INT, `nivel` INT, `descripcion` INT, `id_taller` INT, `id_grupo` INT, `cupo_base` INT, `cupo_extra` INT, `cupo_actual` INT, `periodo` INT, `id_horario` INT, `dia` INT, `hora` INT, `apellido` INT, `nombre` INT, `id_profesor` INT, `cedula` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_matriculados_grupo_detalle`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_matriculados_grupo_detalle` (`id_grupo` INT, `id_estudiante` INT, `cedula_estudiante` INT, `correo_estudiante` INT, `carrera_departamento` INT, `apellido_estudiante` INT, `nombre_estudiante` INT, `foto_estudiante` INT, `sexo_estudiante` INT, `celular_estudiante` INT, `telefono_emergencia_estudiante` INT, `nacimiento_estudiante` INT, `id_profesor` INT, `cedula_profesor` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_matriculados_por_grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_matriculados_por_grupo` (`codigo_taller` INT, `nivel_taller` INT, `descripcion` INT, `id_grupo` INT, `dia` INT, `hora` INT, `nombre_profesor` INT, `id_matricula` INT, `activa` INT, `created_at` INT, `periodo` INT, `id_estudiante` INT, `id_usuario` INT, `cedula` INT, `apellido` INT, `nombre` INT, `foto` INT, `correo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_padecimientos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_padecimientos` (`id_usuario` INT, `cedula` INT, `id_estudiante` INT, `apellido` INT, `nombre` INT, `id_padecimiento` INT, `descripcion` INT, `observaciones` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_profesor_asistencias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_profesor_asistencias` (`id_profesor_asistencia` INT, `estado` INT, `fecha` INT, `id_profesor` INT, `id_usuario` INT, `cedula` INT, `nombre` INT, `apellido` INT, `id_grupo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_profesor_reposiciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_profesor_reposiciones` (`id_reposicion` INT, `id_profesor_origen` INT, `id_usuario_origen` INT, `cedula_origen` INT, `nombre_origen` INT, `apellido_origen` INT, `id_profesor_reposicion` INT, `id_usuario_reposicion` INT, `cedula_reposicion` INT, `nombre_reposicion` INT, `apellido_reposicion` INT, `fecha_reposicion` INT, `id_grupo` INT, `id_horario` INT, `dia` INT, `hora` INT, `id_taller` INT, `codigo_taller` INT, `nivel` INT, `descripcion` INT, `cupo_base` INT, `cupo_extra` INT, `cupo_actual` INT, `periodo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_profesores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_profesores` (`id_usuario` INT, `cedula` INT, `apellido` INT, `nombre` INT, `nacimiento` INT, `usuario` INT, `sexo` INT, `clave` INT, `foto` INT, `correo` INT, `id_profesor` INT, `rol` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_reposiciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_reposiciones` (`id_reposicion` INT, `grupo_origen` INT, `grupo_reposicion` INT, `fecha_reposicion` INT, `comprobante` INT, `observacion` INT, `estado` INT, `id_estudiante` INT, `nivel` INT, `id_usuario` INT, `cedula` INT, `nombre` INT, `apellido` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_usuario_temp`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_usuario_temp` (`id` INT, `cedula` INT, `foto` INT, `nombre` INT, `apellido` INT, `nacimiento` INT, `usuario` INT, `sexo` INT, `tipo_usuario` INT, `creado` INT, `estado` INT, `correo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `siapd`.`vta_usuario_temp_admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siapd`.`vta_usuario_temp_admin` (`id` INT, `cedula` INT, `foto` INT, `nombre` INT, `apellido` INT, `nacimiento` INT, `usuario` INT, `clave` INT, `sexo` INT, `tipo_usuario` INT, `creado` INT, `estado` INT);
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fd_hora_minuto_segundo_actuales`() RETURNS time
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_administrativos`() RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_asistencias_estudiante_grupo`(vps_cedula varchar(11), vpi_grupo int) RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_ausencias_estudiante_grupo`(vps_cedula varchar(11), vpi_grupo int) RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_estudiantes`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_grupos`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_horarios`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_matriculados`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_matriculados_en_grupo`(vpi_id_grupo int) RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_profesores`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_talleres`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_usuarios`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cantidad_usuarios_temp`() RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cantidad int default 0;
    select count(*)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cupo_disponible_grupo`(vpi_id_grupo int) RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_cupos_reposicion_restantes_grupo_fecha`(vpi_id_grupo int, vpd_fecha timestamp) RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_cuenta int default 0;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_id_administrativo_por_cedula`(vps_cedula varchar(45)) RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_id_casillero_casilleroEstudiante_por_id`(vps_id int) RETURNS int(11)
BEGIN
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_id_casillero_por_codigo`(vps_codigo varchar(45)) RETURNS int(11)
    DETERMINISTIC
begin
	declare vli_id_casillero int default 0;
    select id
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_id_estudiante_por_cedula`(vps_cedula varchar(45)) RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_verificar_casillero_vacante`(vps_casillero varchar(45)) RETURNS int(1)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_verificar_usuario_es_administrativo`(vps_cedula varchar(45)) RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_verificar_usuario_es_estudiante`(vps_cedula varchar(45)) RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` FUNCTION `fi_verificar_usuario_es_profesor`(vps_cedula varchar(45)) RETURNS int(11)
    DETERMINISTIC
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_activa_matricula`(in vpi_id int,in vpi_activa int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_apellido_usuario`(in vps_cedula varchar(45), in vps_apellido varchar(100))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_cantidad_dias_estudiante`(in vps_cedula varchar(45),in vpi_cantidad_dias int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_canton_estudiante`(in vps_cedula varchar(45),in vps_canton varchar(50))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_carrera_departamento_estudiante`(in vps_cedula varchar(45),in vps_carrera_departamento varchar(100))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_cedula_usuario`(in vps_cedula_actual varchar(45), in vps_cedula_nueva varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_celular_estudiante`(in vps_cedula varchar(45),in vps_celular varchar(10))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_clave_sha1_usuario`(in vps_cedula varchar(45), in vps_clave varchar(45))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_clave_usuario`(in vps_cedula varchar(45), in vps_clave varchar(45))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_codigo_taller`(in vpi_id int,in vps_codigo varchar(45))
begin 
	update t_taller
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_comprobante_reposicion`(in vpi_id int, in vps_comprobante varchar(100))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_consentimiento_estudiante`(in vps_cedula varchar(45), in vpi_consentimiento tinyint)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_correo_usuario`(in vps_cedula varchar(45),in vps_correo varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_costo_funcionario_taller`(in vpi_id int,in vpi_costo_funcionario int)
begin 
	update t_taller
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_costo_taller`(in vpi_id int,in vpi_costo int)
begin 
	update t_taller
    set costo = vpi_costo
    where id = vpi_id;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_cupo_base_grupo`(in vpi_id int, in vpi_cupo_base int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_datos_cliente_estudiante`(
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_datos_estudiante`(
	in vps_cedula varchar(45), 
	in vps_celular varchar(10),
	in vps_telefono varchar(10), 
	in vpi_nivel int, 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_datos_estudiante_admin`(
	in vps_cedula varchar(45),
    in vps_correo varchar(85),
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_datos_reposicion`(in vpi_id int, in vpi_grupo_origen int, in vpi_grupo_reposicion int, in vpd_fecha_reposicion date, in vps_comprobante varchar(100), in vpi_estado int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_datos_taller`(in vpi_id int, in vps_codigo varchar(45),
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_datos_usuario`(in vps_cedula varchar(45), in vps_foto varchar(100), in vps_nombre varchar(55), in vps_apellido varchar(100),
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_descripcion_padecimiento`(in vpi_id int, vps_descripcion varchar(255))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_descripcion_taller`(in vpi_id int,in vps_descripcion varchar(255))
begin 
	update t_taller
    set descripcion = vps_descripcion
    where id = vpi_id;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_dia_horario`(in vpi_id int, in vps_dia varchar(55))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_direccion_estudiante`(in vps_cedula varchar(45),in vps_direccion varchar(255))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_distrito_estudiante`(in vps_cedula varchar(45),in vps_distrito varchar(60))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_estado_estudiante`(in vps_cedula varchar(45),in vpi_estado int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_estado_estudiante_temporal`(in vps_cedula varchar(45),in vpi_estado int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_estado_reposicion`(in vpi_id int, in vpi_estado int)
begin
	update t_reposicion
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_estudiante_anotaciones`(in vpi_id int, in vpi_estudiante int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_fecha_reposicion_reposicion`(in vpi_id int, in vpd_fecha_reposicion date)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_foto_usuario`(in vps_cedula varchar(45),in vps_foto varchar(100))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_grupo`(
in vpi_id int, 
in vpi_horario int,
in vpi_profesor int, 
in vpi_taller int,
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_grupo_destino_reposicion`(in vpi_id int, in vpi_grupo_destino int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_grupo_origen_reposicion`(in vpi_id int, in vpi_grupo_origen int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_hora_horario`(in vpi_id int, in vpi_hora int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_horario`(in vpi_id int, in vpi_dia varchar(45), in vpi_hora int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_horario_grupo`(in vpi_id int, in vpi_horario int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_matricula_estudiante`(
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_moroso_estudiante`(in vps_cedula varchar(45),in vpi_moroso int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_motivo_ingreso_estudiante`(in vps_cedula varchar(45), in vps_motivo_ingreso varchar(255))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_nacimiento_usuario`(in vps_cedula varchar(45), in vpd_nacimiento date)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_nivel_estudiante`(in vps_cedula varchar(45),in vpi_nivel int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_nivel_taller`(in vpi_id int,in vpi_nivel int)
begin 
	update t_taller
    set nivel = vpi_nivel
    where id = vpi_id;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_nombre_usuario`(in vps_cedula varchar(45), in vps_nombre varchar(55))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_nota_anotaciones`(in vpi_id int, in vps_nota varchar(300))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_notas_estudiante`(in vps_cedula varchar(45),in vps_notas varchar(255))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_observacion_padecimiento`(in vpi_id int, vps_observaciones varchar(255))
begin 
	update t_padecimiento 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_prematricula_estudiante`(in vps_cedula varchar(45),in vpd_prematricula date)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_profesor_anotaciones`(in vpi_id int, in vpi_profesor int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_profesor_grupo`(in vpi_id int, in vpi_profesor int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_provincia_estudiante`(in vps_cedula varchar(45),in vps_provincia varchar(11))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_rol_administrativo`(in vps_cedula varchar(45), in vpi_rol int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_sexo_usuario`(in vps_cedula varchar(45), in vps_sexo varchar(45))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_taller`(in vpi_id int, in vpi_descripcion VARCHAR(45),  in vpi_nivel int, in vpi_costo int, in vpi_costof int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_telefono_emergencia_estudiante`(in vps_cedula varchar(45),in vps_telefono_emergencia varchar(150))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_telefono_estudiante`(in vps_cedula varchar(45),in vps_telefono varchar(10))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_updated_at_usuario`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_updated_at_usuario_temp`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_actualizar_usuario_usuario`(in vps_cedula varchar(45), in vps_usuario varchar(45))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_agregar_actividad`(in vps_usuario varchar(45),in vps_descripcion varchar(100))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_cambiar_usuario_temp_a_permanente`(IN `vps_cedula` VARCHAR(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_cambiar_usuario_temp_estado`(
in vps_cedula varchar(45)
)
BEGIN
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_cuenta_repo_aceptada_nivel_gf`(in vpi_nivel int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_administrativo`(in vps_cedula varchar(45))
BEGIN
	declare vli_id int;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_anotaciones`(in vpi_id int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_asistencia`(in vpi_id int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_casillero`(in vpv_codigo varchar(45))
BEGIN
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_casillero_estudiante`(in vpi_id int, in vpv_codigo varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_documento_usuario`(in vpi_id int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_grupo`(in vpi_id int)
begin
	delete from t_grupo
    where id = vpi_id;
end$$
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_horario`(in vpi_id int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_matricula`(in vpi_id_matricula int)
begin
	delete from t_matricula
    where id = vpi_id_matricula;
end$$
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_padecimiento`(in vpi_id int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_profesor`(in vpi_id int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_reposicion`(in vpi_id int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_taller`(in vpi_id int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_usuario`(in vps_cedula VARCHAR(15))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_eliminar_usuario_temp`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_actividad`(in vps_usuario varchar(45), in vps_descripcion varchar(100), in vps_ddl varchar(45), in vps_tabla varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_administrador`(
IN `vps_cedula` VARCHAR(45),
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_administrativo`(in vpi_rol int, in vpi_usuario int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_anotaciones`(in vps_nota varchar(300), in vpi_profesor int, in vpi_estudiante int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_asistencia`(in vpi_estado varchar(25), in vpi_estudiante int, in vpi_grupo int, in vpi_fecha varchar(30))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_casillero`(in vpi_codigo VARCHAR(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_casillero_estudiante`(in vps_cedula varchar(45), in vps_codigo_casillero varchar(45), in vpd_hora_entrada time, in vpd_hora_salida time)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_conducta`(in vpi_id int,in vpi_nota VARCHAR(300),in vpi_tipo VARCHAR(45))
BEGIN
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_documento_usuario`(in vpi_tipo_documento int, in vps_documento varchar(100), in vpi_usuario int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_estudiante`(in vpi_usuario int, in vpi_tipo VARCHAR(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_grupo`(in vpi_horario int, in vpi_profesor int, in vpi_taller int, in vpi_cupo_base int, in vpi_cupo_extra int, in vpd_periodo date)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_horario`(in vps_dia varchar(55), in vpi_hora int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_matricula`(in vpi_grupo int, in vpi_estudiante int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_padecimiento_estudiante`(in vps_descripcion varchar(255),in vpi_estudiante int, in vps_observacion varchar(255))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_profesor`(in vpi_usuario int)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_profesor_asistencia`(in vpi_estado VARCHAR(15), in vps_fecha varchar(30), in vpi_profesor int(11), in vpi_grupo int(11))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_profesor_reposicion`(
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_reposicion`(in vpi_estudiante int, in vpi_grupo_origen int, 
in vpi_grupo_reposicion int, in vpd_fecha_reposicion date, in vps_observacion varchar(255),in vps_comprobante varchar(100))
begin 
	insert into t_reposicion(estudiante, grupo_origen, grupo_reposicion, fecha_reposicion, observacion, comprobante)
    values (vpi_estudiante, vpi_grupo_origen, vpi_grupo_reposicion, vpd_fecha_reposicion, vps_observacion,vps_comprobante);
    commit;
end$$
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_t_usuario`(
IN `vps_cedula` VARCHAR(45), 
...
begin
	...
	insert into `siapd`.`t_usuario`(`cedula`, `nombre`, `apellido`, `nacimiento`, `usuario`, `clave`, `sexo`, `correo`)
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_taller`(in vps_codigo varchar(45), in vps_descripcion varchar(255), in vpi_nivel int, in vpi_costo int, in vpi_costo_funcionario int)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_usuario`(IN `vps_cedula` VARCHAR(45), IN `vps_nombre` VARCHAR(55), IN `vps_apellido` VARCHAR(100), IN `vpd_nacimiento` DATE, IN `vps_usuario` VARCHAR(45), IN `vps_clave` VARCHAR(45), IN `vps_sexo` VARCHAR(45), IN `vps_correo` VARCHAR(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_usuario_admin`(
IN `vps_cedula` VARCHAR(45), 
IN `vps_nombre` VARCHAR(55), 
IN `vps_apellido` VARCHAR(100), 
IN `vpd_nacimiento` DATE, 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_insertar_usuario_temp`(
in vps_cedula varchar(45),
in vps_nombre varchar(55),
in vps_apellido varchar(100),
in vpd_nacimiento date,
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_mostrar_actividad_fecha`(in vpd_fecha date)
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_mostrar_actividad_usuario`(in vps_usuario varchar(45))
begin
	select * from t_actividad
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_mostrar_actividad_usuario_ddl`(in vps_usuario varchar(45), in vps_ddl varchar(45))
begin
		select * from t_actividad
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_mostrar_disponibilidad_casilleros`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_mostrar_usuarios_morosos`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_actividad`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_administrativo_cedula`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_anotaciones_por_cedula_estudiante`(in vps_cedula_estudiante varchar(45))
begin	
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_anotaciones_por_cedula_profesor`(in vps_cedula_profesor varchar(45))
begin
	select * from vta_anotaciones
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_anotaciones_por_profesor_y_estudiante`(in vps_cedula_profesor varchar(45), in vps_cedula_estudiante varchar(45))
begin
	select * from vta_anotaciones
    where cedula_profesor = vps_cedula_profesor
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_asistencia`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_asistencia_por_dia`(in vpd_dia date)
begin
	select * from vta_asistencia
    where dia = vpd_dia
    and estado = 1;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_asistencia_por_estudiante`(in vps_cedula varchar(45))
begin
	select * from vta_asistencia
    where cedula = vps_cedula
    and estado = 1;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_asistencia_por_grupo`(in vpi_id_grupo int)
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
    and estado = 1;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_asistencia_por_grupo_y_dia`(in vpi_id_grupo int, in vpd_dia date)
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
    and dia = vpd_dia
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_asistencia_por_grupo_y_estudiante`(in vpi_id_grupo int, in vps_cedula varchar(45))
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_asistencia_por_grupo_y_estudiante_y_dia`(in vpi_id_grupo int, in vps_cedula varchar(45), in vpd_dia date)
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
    and dia = vpd_dia
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_ausencias`()
begin
	select * from vta_asistencia
    where estado = 0;
 end$$
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_ausencias_por_dia`(in vpd_dia date)
begin
	select * from vta_asistencia
    where dia = vpd_dia
    and estado = 0;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_ausencias_por_estudiante`(in vps_cedula varchar(45))
begin
	select * from vta_asistencia
    where cedula = vps_cedula
    and estado = 0;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_ausencias_por_grupo`(in vpi_id_grupo int)
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
    and estado = 0;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_ausencias_por_grupo_y_dia`(in vpi_id_grupo int, in vpd_dia date)
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
    and dia = vpd_dia
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_ausencias_por_grupo_y_estudiante`(in vpi_id_grupo int, in vps_cedula varchar(45))
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
    and cedula = vps_cedula
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_ausencias_por_grupo_y_estudiante_y_dia`(in vpi_id_grupo int, in vps_cedula varchar(45), in vpd_dia date)
begin
	select * from vta_asistencia
    where id_grupo = vpi_id_grupo
    and dia = vpd_dia
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_documentos_usuario`()
BEGIN
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_documentos_usuario_por_cedula`(in vps_cedula varchar(45))
BEGIN
	select * from vta_documentos_usuarios
    where cedula = vps_cedula
    order by cedula, id_documento;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_documentos_usuario_por_cedula_y_tipo`(in vps_cedula varchar(45), in vpi_tipo int)
BEGIN
	select * from vta_documentos_usuarios
    where cedula = vps_cedula
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_estudiante_cedula`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_estudiante_cedula_admin`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_horarios`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_matricula_por_estudiante`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_padecimientos_estudiante`(in vps_cedula varchar(11))
begin 
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_profesor_cedula`(in vps_cedula varchar(45))
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_profesores`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_reposiciones_aprobadas`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_reposiciones_aprobadas_cedula`(in vps_cedula varchar(45))
begin
	select * from vta_reposiciones
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_reposiciones_aprobadas_por_grupo`(in vpi_grupo int)
begin
	select * from vta_reposiciones
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_reposiciones_aprobadas_por_grupo_y_fecha`(in vpi_grupo int, in vpd_fecha date)
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_reposiciones_por_cedula`(in vps_cedula varchar(45))
begin
	select * from vta_reposiciones 
    where cedula = vps_cedula;
end$$
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_reposiciones_por_grupo`(in vpi_grupo int)
begin
	select * from vta_reposiciones
    where grupo_reposicion = vpi_grupo;
 end$$
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_reposiciones_por_nivel`(in vpi_nivel int)
begin
	select * from vta_reposiciones
    where nivel = vpi_nivel;
 end$$
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_talleres`()
begin
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_talleres_por_nivel`(in vpi_nivel int)
begin
	select * from t_taller
    where nivel = vpi_nivel
    order by codigo;
...
DELIMITER $$
USE `siapd`$$
CREATE DEFINER=`siapuseradmin`@`localhost` PROCEDURE `prc_seleccionar_usuarios`()
begin
...
-- -----------------------------------------------------
-- View `siapd`.`vta_admin_estudiante`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `siapd`.`vta_admin_estudiante`;
USE `siapd`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`siapuseradmin`@`localhost` SQL SECURITY DEFINER VIEW `siapd`.`vta_admin_estudiante` AS select `u`.`id` AS `id`,`u`.`cedula` AS `cedula`,`u`.`foto` AS `foto`,`u`.`apellido` AS `apellido`,`u`.`nombre` AS `nombre`,`u`.`nacimiento` AS `nacimiento`,`u`.`usuario` AS `usuario`,`u`.`sexo` AS `sexo`,`u`.`correo` AS `correo`,`e`.`id` AS `id_estudiante`,`e`.`celular` AS `celular`,`e`.`telefono` AS `telefono`,`e`.`nivel` AS `nivel`,`n`.`descripcion` AS `descripcion`,`e`.`carrera_departamento` AS `carrera_departamento`,`e`.`cantidad_dias` AS `cantidad_dias`,`e`.`telefono_emergencia` AS `telefono_emergencia`,`e`.`provincia` AS `provincia`,`e`.`canton` AS `canton`,`e`.`distrito` AS `distrito`,`e`.`direccion` AS `direccion`,`e`.`moroso` AS `moroso`,`e`.`estado` AS `estado`,`e`.`notas` AS `notas`,`e`.`prematricula` AS `prematricula`,`e`.`motivo_ingreso` AS `motivo_ingreso`,`e`.`tipo` AS `tipo` from ((`siapd`.`t_usuario` `u` join `siapd`.`t_estudiante` `e`) join `siapd`.`t_taller` `n`) where ((`u`.`id` = `e`.`usuario`) and (`e`.`nivel` = `n`.`nivel`));

-- -----------------------------------------------------
-- View `siapd`.`vta_administradores`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `siapd`.`vta_administradores`;
USE `siapd`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`siapuseradmin`@`localhost` SQL SECURITY DEFINER VIEW `siapd`.`vta_administradores` AS select `u`.`id` AS `id`,`u`.`cedula` AS `cedula`,`u`.`foto` AS `foto`,`u`.`nombre` AS `nombre`,`u`.`apellido` AS `apellido`,`u`.`nacimiento` AS `nacimiento`,`u`.`usuario` AS `usuario`,`u`.`sexo` AS `sexo`,`u`.`correo` AS `correo`,`u`.`clave` AS `clave`,`a`.`id` AS `id_administrativo`,`a`.`rol` AS `rol` from (`siapd`.`t_usuario` `u` join `siapd`.`t_administrativo` `a`) where (`u`.`id` = `a`.`usuario`) order by `u`.`apellido`,`u`.`nombre`;

-- -----------------------------------------------------
-- View `siapd`.`vta_anotaciones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `siapd`.`vta_anotaciones`;
USE `siapd`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`siapuseradmin`@`localhost` SQL SECURITY DEFINER VIEW `siapd`.`vta_anotaciones` AS select `a`.`id` AS `id_anotaciones`,`a`.`nota` AS `nota`,`a`.`profesor` AS `id_profesor`,`a`.`created_at` AS `created_at`,`a`.`updated_at` AS `updated_at`,`up`.`cedula` AS `cedula_profesor`,`up`.`apellido` AS `apellido_profesor`,`up`.`nombre` AS `nombre_profesor`,`a`.`estudiante` AS `id_estudiante`,`ue`.`cedula` AS `cedula_estudiante`,`ue`.`apellido` AS `apellido_estudiante`,`ue`.`nombre` AS `nombre_estudiante` from ((((`siapd`.`t_anotaciones` `a` join `siapd`.`t_profesor` `p`) join `siapd`.`t_estudiante` `e`) join `siapd`.`t_usuario` `up`) join `siapd`.`t_usuario` `ue`) where ((`a`.`profesor` = `p`.`id`) and (`p`.`usuario` = `up`.`id`) and (`a`.`estudiante` = `e`.`id`) and (`e`.`usuario` = `ue`.`id`)) order by `up`.`cedula`,`ue`.`cedula`,`a`.`id`;

-- -----------------------------------------------------
-- View `siapd`.`vta_asistencia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `siapd`.`vta_asistencia`;
USE `siapd`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`siapuseradmin`@`localhost` SQL SECURITY DEFINER VIEW `siapd`.`vta_asistencia` AS select distinct `a`.`id` AS `id_asistencia`,`a`.`fecha` AS `fecha`,`m`.`id` AS `id_matricula`,`g`.`id` AS `id_grupo`,`t`.`id` AS `id_taller`,`t`.`codigo` AS `codigo`,`e`.`id` AS `id_estudiante`,`u`.`foto` AS `foto`,`u`.`id` AS `id_usuario`,`u`.`cedula` AS `cedula`,`u`.`apellido` AS `apellido`,`u`.`nombre` AS `nombre`,`a`.`estado` AS `estado` from (((((`siapd`.`t_asistencia` `a` join `siapd`.`t_matricula` `m`) join `siapd`.`t_grupo` `g`) join `siapd`.`t_taller` `t`) join `siapd`.`t_estudiante` `e`) join `siapd`.`t_usuario` `u`) where ((`a`.`estudiante` = `e`.`id`) and (`a`.`grupo` = `g`.`id`) and (`g`.`taller` = `t`.`id`) and (`m`.`estudiante` = `e`.`id`) and (`m`.`grupo` = `g`.`id`) and (`e`.`usuario` = `u`.`id`));

-- -----------------------------------------------------
-- View `siapd`.`vta_asistencia_admin`
-- -----------------------------------------------------
